      ...
      new Table({
        ...
        columns: [
          ...
          },
          {
            ...
            scale: 4,
            default: 0.20,
            comment: 'Commission rate for temporary merchant packages (e.g., 0.20 = 20%)',
          },
          {
            ...
            scale: 4,
            default: 0.02,
            comment: 'Commission rate for annual merchant packages (e.g., 0.02 = 2%)',
          },
          {
          ...
          },
          {
            ...
            scale: 4,
            default: 0.75,
            comment: 'Commission rate admin gets for merchant annual subscription upgrades (e.g., 0.75 = 75%)',
          },
          {
            name: 'currency',
            type: 'varchar',
